...
> redaction (§4.3). MCP SSE / streamable-http remote transport with bearer-token
> auth (§3.11) shipped post-0.7.0 (see CHANGELOG "Unreleased"). Still future:
> SPARQL/SQL *query generation* (§6.4).
